...
<body>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                <h5>Cards</h5>
                                <h2><span class="counter">0</span> <span class="amount"></span></h2>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="single-cards-item">
                            <div class="single-product-image">
                                <a href="#"><asset:image src="product/profile-bg.jpg" alt=""/></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="single-review-st-item res-mg-t-30 table-mg-t-pro-n">
                            ...
                            <div class="single-review-st-text">
                                <asset:image src="notification/1.jpg" alt=""/>
                            ...
                            <div class="single-review-st-text">
                                <asset:image src="notification/2.jpg" alt=""/>
                                <div class="review-ctn-hf">
                                    <h3>Garbease sha</h3>
                                    <p>Awesome Pro</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <asset:image src="notification/3.jpg" alt=""/>
                                <div class="review-ctn-hf">
                                    <h3>Gobetro pro</h3>
                                    <p>Great Website</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <asset:image src="notification/4.jpg" alt=""/>
                                <div class="review-ctn-hf">
                                    <h3>Siam Graves</h3>
                                    <p>That's Good</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <asset:image src="notification/5.jpg" alt=""/>
                                <div class="review-ctn-hf">
                                    <h3>Sarah Graves</h3>
                                    <p>Highly recommend</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <asset:image src="notification/6.jpg" alt=""/>
                                <div class="review-ctn-hf">
                                    <h3>Julsha Grav</h3>
                                    <p>Sei Hoise bro</p>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="single-product-item res-mg-t-30 table-mg-t-pro-n tb-sm-res-d-n dk-res-t-d-n">
                            <div class="single-product-image">
                                <a href="#"><asset:image src="product/book-4.jpg" alt=""/></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="courses-inner res-mg-t-30 table-mg-t-pro-n tb-sm-res-d-n dk-res-t-d-n">
                            <div class="courses-title">
                                <a href="#"><asset:image src="courses/1.jpg" alt="" /></a>
    ...
    <!-- counterup JS
		============================================ -->
    <asset:javascript src="counterup/jquery.counterup.min.js"/>
    <asset:javascript src="counterup/waypoints.min.js"/>
    <asset:javascript src="counterup/counterup-active.js"/>
    <!-- mCustomScrollbar JS
		============================================ -->
    ...
    <!-- morrisjs JS
		============================================ -->
    <asset:javascript src="morrisjs/raphael-min.js"/>
    <asset:javascript src="morrisjs/morris.js"/>
    <asset:javascript src="morrisjs/morris-active.js"/>
    <!-- morrisjs JS
		============================================ -->
    <asset:javascript src="sparkline/jquery.sparkline.min.js"/>
    <asset:javascript src="sparkline/jquery.charts-sparkline.js"/>
    <asset:javascript src="sparkline/sparkline-active.js"/>
    <!-- calendar JS
		============================================ -->
    <asset:javascript src="calendar/moment.min.js"/>
    <asset:javascript src="calendar/fullcalendar.min.js"/>
    <asset:javascript src="calendar/fullcalendar-active.js"/>
    <!-- plugins JS
		============================================ -->
