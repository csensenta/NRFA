...
<head>
    ...
    <!-- Google Fonts
		============================================ -->
    <asset:link href="https://fonts.googleapis.com/css?family=Roboto:100,300,400,700,900" rel="stylesheet"/>
    <!-- Bootstrap CSS
		============================================ -->
    ...
    <!-- owl.carousel CSS
		============================================ -->
    <asset:link rel="stylesheet" href="owl.carousel.css"/>
    <asset:link rel="stylesheet" href="owl.theme.css"/>
    <asset:link rel="stylesheet" href="owl.transitions.css"/>
    <!-- animate CSS
		============================================ -->
    <asset:link rel="stylesheet" href="animate.css"/>
    <!-- normalize CSS
		============================================ -->
    <asset:link rel="stylesheet" href="normalize.css"/>
    <!-- meanmenu icon CSS
		============================================ -->
    <asset:link rel="stylesheet" href="meanmenu.min.css"/>
    <!-- main CSS
		============================================ -->
    <asset:link rel="stylesheet" href="main.css"/>
    <!-- educate icon CSS
		============================================ -->
    <asset:link rel="stylesheet" href="educate-custon-icon.css"/>
    <!-- morrisjs CSS
		============================================ -->
    <asset:link rel="stylesheet" href="morrisjs/morris.css"/>
    <!-- mCustomScrollbar CSS
		============================================ -->
    <asset:link rel="stylesheet" href="scrollbar/jquery.mCustomScrollbar.min.css"/>
    <!-- metisMenu CSS
		============================================ -->
    <asset:link rel="stylesheet" href="metisMenu/metisMenu.min.css"/>
    <asset:link rel="stylesheet" href="metisMenu/metisMenu-vertical.css"/>
    <!-- calendar CSS
		============================================ -->
    <asset:link rel="stylesheet" href="calendar/fullcalendar.min.css"/>
    <asset:link rel="stylesheet" href="calendar/fullcalendar.print.min.css"/>
    <!-- x-editor CSS
		============================================ -->
    <asset:link rel="stylesheet" href="editor/select2.css"/>
    <asset:link rel="stylesheet" href="editor/datetimepicker.css"/>
    <asset:link rel="stylesheet" href="editor/bootstrap-editable.css"/>
    <asset:link rel="stylesheet" href="editor/x-editor-style.css"/>
    <!-- normalize CSS
		============================================ -->
    <asset:link rel="stylesheet" href="data-table/bootstrap-table.css"/>
    <asset:link rel="stylesheet" href="data-table/bootstrap-editable.css"/>
    <!-- style CSS
		============================================ -->
    ...
    <!-- modernizr JS
		============================================ -->
    <asset:javascript  src="js/vendor/modernizr-2.8.3.min.js"/>
</head>
...
<div class="left-sidebar-pro">
    <nav id="sidebar" class="">
        <div class="sidebar-header">
            <a href="index.html"><asset:image  class="main-logo" src="logo/logo.png" alt="" /></a>
            <strong><a href="index.html"><asset:image  src="logo/logosn.png" alt="" /></a></strong>
        </div>
                                        ...
                                        <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <div role="menu" class="author-message-top dropdown-menu animated zoomIn">
                                                    ...
                                                    <ul class="message-menu">
                                                        <li>
                                                            <a href="#">
                                                                <div class="message-img">
                                                                    <asset:image src="contact/1.jpg" alt=""/>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="#">
                                                                <div class="message-img">
                                                                    <asset:image  src="contact/4.jpg" alt=""/>
                                                                </div>
                                                                <div class="message-content">
                                                                    <span class="message-date">16 Sept</span>
                                                                    <h2>Sulaiman din</h2>
                                                        ...
                                                        <li>
                                                            <a href="#">
                                                                <div class="message-img">
                                                                    <asset:image  src="contact/3.jpg" alt=""/>
                                                                </div>
                                                                <div class="message-content">
                                                                    <span class="message-date">16 Sept</span>
                                                                    <h2>Victor Jara</h2>
                                                        ...
                                                        <li>
                                                            <a href="#">
                                                                <div class="message-img">
                                                                    <asset:image src="contact/2.jpg" alt=""/>
                                                                </div>
                                                                <div class="message-content">
                                                                    <span class="message-date">16 Sept</span>
                                                                    <h2>Victor Jara</h2>
                                            ...
                                            <li class="nav-item">
                                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                    <asset:image src="product/pro4.jpg" alt="" />
...
<!-- jquery
		============================================ -->
<asset:javascript src="vendor/jquery-1.12.4.min.js"/>
<!-- bootstrap JS
		============================================ -->
...
<!-- price-slider JS
		============================================ -->
<asset:javascript  src="jquery-price-slider.js"/>
<!-- meanmenu JS
		============================================ -->
<asset:javascript  src="jquery.meanmenu.js"/>
<!-- owl.carousel JS
		============================================ -->
...
<!-- scrollUp JS
		============================================ -->
<asset:javascript  src="jquery.scrollUp.min.js"/>
<!-- mCustomScrollbar JS
		============================================ -->
<asset:javascript  src="scrollbar/jquery.mCustomScrollbar.concat.min.js"/>
<asset:javascript  src="scrollbar/mCustomScrollbar-active.js"/>
<!-- metisMenu JS
		============================================ -->
<asset:javascript  src="metisMenu/metisMenu.min.js"/>
<asset:javascript  src="metisMenu/metisMenu-active.js"/>
<!-- data table JS
		============================================ -->
<asset:javascript  src="data-table/bootstrap-table.js"/>
<asset:javascript  src="data-table/tableExport.js"/>
<asset:javascript  src="data-table/data-table-active.js"/>
<asset:javascript  src="data-table/bootstrap-table-editable.js"/>
<asset:javascript  src="data-table/bootstrap-editable.js"/>
<asset:javascript  src="data-table/bootstrap-table-resizable.js"/>
<asset:javascript  src="data-table/colResizable-1.5.source.js"/>
<asset:javascript  src="data-table/bootstrap-table-export.js"/>
<!--  editable JS
		============================================ -->
<asset:javascript  src="editable/jquery.mockjax.js"/>
<asset:javascript  src="editable/mock-active.js"/>
<asset:javascript  src="editable/select2.js"/>
<asset:javascript  src="editable/moment.min.js"/>
<asset:javascript  src="editable/bootstrap-datetimepicker.js"/>
<asset:javascript  src="editable/bootstrap-editable.js"/>
<asset:javascript  src="editable/xediable-active.js"/>
<!-- Chart JS
    ============================================ -->
<asset:javascript  src="chart/jquery.peity.min.js"/>
<asset:javascript  src="peity/peity-active.js"/>
<!-- tab JS
		============================================ -->
...
<!-- tawk chat JS
		============================================ -->
<asset:javascript  src="tawk-chat.js"/>
</body>
